...
var require_lib = __commonJS({
  "node_modules/webidl-conversions/lib/index.js"(exports$1, module) {
    var conversions = {};
...
var require_utils = __commonJS({
  "node_modules/whatwg-url/lib/utils.js"(exports$1, module) {
...
var require_mappingTable = __commonJS({
  "node_modules/tr46/lib/mappingTable.json"(exports$1, module) {
...
var require_tr46 = __commonJS({
  "node_modules/tr46/index.js"(exports$1, module) {
...
var require_url_state_machine = __commonJS({
  "node_modules/whatwg-url/lib/url-state-machine.js"(exports$1, module) {
    var punycode = __require("punycode");
...
var require_URL_impl = __commonJS({
  "node_modules/whatwg-url/lib/URL-impl.js"(exports$1) {
    var usm = require_url_state_machine();
    exports$1.implementation = class URLImpl {
...
var require_URL = __commonJS({
  "node_modules/whatwg-url/lib/URL.js"(exports$1, module) {
...
var require_public_api = __commonJS({
  "node_modules/whatwg-url/lib/public-api.js"(exports$1) {
    exports$1.URL = require_URL().interface;
    exports$1.serializeURL = require_url_state_machine().serializeURL;
    exports$1.serializeURLOrigin = require_url_state_machine().serializeURLOrigin;
    exports$1.basicURLParse = require_url_state_machine().basicURLParse;
    exports$1.setTheUsername = require_url_state_machine().setTheUsername;
    exports$1.setThePassword = require_url_state_machine().setThePassword;
    exports$1.serializeHost = require_url_state_machine().serializeHost;
    exports$1.serializeInteger = require_url_state_machine().serializeInteger;
    exports$1.parseURL = require_url_state_machine().parseURL;
  }
});
...
var init_lib = __esm({
  "node_modules/node-fetch/lib/index.mjs"() {
    ...
    URL = Url__default.default.URL || import_whatwg_url.default.URL;
...
var require_node_ponyfill = __commonJS({
  "node_modules/cross-fetch/dist/node-ponyfill.js"(exports$1, module) {
  ...
  return function(parsed, resolve) {
    try {
      let _temp22 = function(_result) {
        ...
        const cached = cache4.get(parsed.didUrl);
        return cached !== void 0 ? cached : Promise.resolve(resolve()).then(function(result) {
          ...
          if (((_result$didResolution = result.didResolutionMetadata) == null ? void 0 : _result$didResolution.error) !== "notFound") {
            cache4.set(parsed.didUrl, result);
          }
          return result;
        });
      };
...
var get = function(url) {
  try {
    return Promise.resolve((0, import_cross_fetch.default)(url, {
      mode: "cors"
    })).then(function(res) {
      if (res.status >= 400) {
